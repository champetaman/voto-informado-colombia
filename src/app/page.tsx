        ...
        <div className="app-container py-14">
          ...
          <div className="mt-8 grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-slateui">
              ...
              intención de voto para revisar coincidencias programáticas con más
              contexto. No es una encuesta electoral, no predice resultados y no
              recomienda votar por ninguna fórmula.
            </p>
